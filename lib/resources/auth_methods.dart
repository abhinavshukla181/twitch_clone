...
import 'package:twitch_clone/models/users.dart' as model;
        ...
        Provider.of<UserProvider>(context, listen: false).setUser(
          model.User.fromMap(
            await getCurrentUser(cred.user!.uid) ??
                {}, //we are setting thee user by getting user from getCurrentUser
            //then converting the getCurrentUsr map into UsermOdel
          ),
        );
        res = true;
      }
